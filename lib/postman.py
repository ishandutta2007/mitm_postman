...
class Postman:
    def __init__(self, host, collection_name="TestCollection"):
        ...
        """
        ctx.log.info("INITATING POSTMAN")
        self.host = host
        self.collection = Collection(name=collection_name)
        self.folder_dict = {}
        ctx.log.info("INITATING POSTMAN:", flow.request.host + " " + self.host)
        print("INITATING POSTMAN : ", flow.request.host, self.host)
    ...
    def request(self, flow):
        ...
        """
        ctx.log.info(
            "INITATING POSTMAN REQUEST CONSTRUCTION:"
            + flow.request.host
            + " "
            + self.host
        )
        print("INITATING POSTMAN REQUEST CONSTRUCTION:", flow.request.host, self.host)
